...
import 'package:dialysisflow/features/auth/presentation/controllers/login_controller.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  final LoginController _loginController =
      LoginController(ServiceLocator.authRepository);
  ...
  Future<void> _handleLogin(
    ...
    try {
      final isAuthenticated = await _loginController.signIn(
        username: username,
        password: password,
      );
