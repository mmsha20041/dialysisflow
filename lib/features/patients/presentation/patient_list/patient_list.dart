...
import 'package:dialysisflow/features/patients/presentation/controllers/patient_list_controller.dart';
...
class _PatientListState extends State<PatientList>
  ...
  final PatientListController _controller =
      PatientListController(ServiceLocator.patientRepository);
  ...
  Future<void> _loadPatients() async {
    ...
    final patients = await _controller.loadPatients();
    final filters = await _controller.loadFilters();
